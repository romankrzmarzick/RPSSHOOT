...
class MarkovChain: 
    ...
    def figure_markov(self, rules: dict): 
        for i in rules:
            for x in rules:
    ...
    def weighted_random(self, move) -> str:
